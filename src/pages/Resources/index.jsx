...
const TYPES = [
  ...
  { key: 'audio', label: 'Audio Sermons', icon: HeadsetIcon, color: colors.accent.teal },
  { key: 'video', label: 'Video Messages', icon: VideocamIcon, color: '#8B5CF6' },
  { key: 'study', label: 'Bible Study', icon: MenuBookIcon, color: colors.accent.green },
  { key: 'ebook', label: 'eBooks & Docs', icon: DownloadIcon, color: colors.accent.red },
];

/* ── Resources come from admin dashboard ── */
const RESOURCES = [];
      ...
      <Box sx={{ bgcolor: '#0D1117', pt: { xs: 14, md: 16 }, pb: { xs: 6, md: 8 }, position: 'relative', overflow: 'hidden' }}>
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1 }}>
          <Box sx={{ animation: 'rs_rise .6s ease both' }}>
            ...
            <Typography sx={{ fontFamily: typography.fontFamily.body, fontSize: typography.fontSize.base, color: 'rgba(255,255,255,0.45)', maxWidth: 500, lineHeight: 1.85 }}>
              Audio sermons, video messages, Bible study materials and more — resources to strengthen your faith, fuel evangelism and equip you for the Great Commission.
            </Typography>
          </Box>
        </Container>
          ...
          {filtered.length > 0 ? (
            ...
            <Box sx={{ textAlign: 'center', py: { xs: 8, md: 12 } }}>
              ...
              <Typography sx={{ fontFamily: typography.fontFamily.body, color: colors.text.secondary, mb: 1 }}>
                We are uploading sermons, teachings and study materials from our ministers.
              </Typography>
